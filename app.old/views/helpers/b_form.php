...
class BFormHelper extends FormHelper {
	...
	public function input( $fieldName, $options = array() ){
		...
		unset( $options[ 'label' ] );
		$str .= parent::input( $fieldName, array_merge( array( 'label' => false, 'div' => 'controls', 'escape' => false, 'before' => $before, 'after' => $after, 'error' => array( 'wrap' => 'span', 'class' => 'help-inline' ) ), $options ) );
		$str .= '</div>';
		return $str;
	}
